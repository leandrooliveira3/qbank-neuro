          ...
          <div className="flex-1 bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-900 rounded-[2.5rem] p-6 md:p-10 shadow-xl overflow-y-auto custom-scrollbar min-h-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                {frontPreview ? (
                  <div className="relative rounded-[1.5rem] border border-slate-200 dark:border-zinc-800 bg-black flex items-center justify-center p-2 min-h-[200px] overflow-hidden">
                      <div className="relative inline-flex max-w-full max-h-[300px]"><img src={frontPreview} className="max-w-full max-h-[300px] object-contain flex-shrink-0" />{occlusions.map(occ => (<div key={occ.id} style={{ left: `${occ.x}%`, top: `${occ.y}%`, width: `${occ.width}%`, height: `${occ.height}%` }} className="absolute bg-yellow-500/50 border border-yellow-300 z-10" />))}</div>
